...
@Service
public class PostgresBookRentalRankingService {
    private final PostgresBookRentalRepository repository;

    public PostgresBookRentalRankingService(PostgresBookRentalRepository repository) {
