...
@Service
public class MssqlUserAccountUpdateService {
    private static final String SELECT_PREVIOUS_PERMISSION_ID = """
            SELECT TOP 1 ua.permissionsId
    ...
    public MssqlUserAccountUpdateService(@Qualifier("mssqlDataSource") DataSource dataSource) {
